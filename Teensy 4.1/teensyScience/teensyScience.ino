...
void updateMotors(CANMessage message) {
  ...
  // UDPATE DRILL
  drillSpeed = map(drillSpeed, 0, 252, 0, 180);
...
void setup()
{
  ...
  pinMode(TEST_TUBE_DOWN_PIN, OUTPUT);
  ...
  servoCam.attach(SERVO_CAM_PIN, 900, 2100);
